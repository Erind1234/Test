    ...
    public class FiscalizationController : Controller
    {
        ...
        public ActionResult SaveQRCodeValue(string QRCODEVAL)
        {
            try
            {
               ...
               /* empRepo.SaveFiscalization(emp);*/ // Replace with your actual repository method
        ...
        [HttpPost]
        public ActionResult SaveFiscalization(EmpModel emp,string QRCODEVAL)
        {
            try
            {
...
<body>
                        ...
                        @Html.DropDownListFor(model => model.STPROFILE, new SelectList(new[]
   {
                ...
                @Html.Hidden("QRCODEVAL", null, new { id = "" })
