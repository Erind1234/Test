...
<body>
                        ...
                        @Html.DropDownListFor(model => model.STPROFILE, new SelectList(new[]
   {
                ...
                @Html.HiddenFor(model => model.QRCODEVAL, new { id = "QRCODEVAL" })
                ...
                $(document).ready(function () {
                    ...
                    $("#scan").click(function () {
                        ...
                        $("#tab1").html(data).show();
                            ...
                            $(document).ready(function () {
                        // Attach a click event handler to the "Ruaj" button to update QRCODEVAL
                            $("#scan").click(function () {
...
namespace InApps.Controllers
{
    ...
    public class FiscalizationController : Controller
    {
        ...
        public ActionResult SaveFiscalization(EmpModel emp)
        {
            try
            {
                string searchBoxValue = Request.Form["searchBox"];
                emp.QRCODEVAL = searchBoxValue;
